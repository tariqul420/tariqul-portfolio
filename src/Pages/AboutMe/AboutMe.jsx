            ...
            <div className="flex relative flex-col gap-20 lg:flex-row items-center">
                ...
                <div className="lg:w-[70%] flex flex-col items-center lg:items-start text-dark-lite dark:text-white-deep">
                    ...
                    <p className="text-justify text-lg font-medium leading-[31px]">
                        ...
                        <strong>Junior Frontend Developer</strong> focused on creating{" "}
            ...
            <div className="mt-10">
                    ...
                    <ul className="mt-3 space-y-2">
                        <li> -
                            <a href="https://kutto-0.web.app/" target="_blank" className="text-primary2 hover:underline ml-2 font-semibold">
                                Kutto
                            </a> → A pet adoption platform connecting users with pets in need of loving homes.
                        </li>
                        <li> -
                ...
                <div className="mt-10">
                    ...
                    <p className="mt-3 text-lg">
                        ...
                        or reading about the latest advancements in tech. I believe that learning is a never-ending journey,
                        and I’m always eager to grow, improve, and push the boundaries of what’s possible.
                    </p>
                </div>
