    ...
    <footer className="py-4 px-4  border border-solid dark:border-none bg-gradient-to-r from-white to-white dark:bg-gradient-to-r dark:from-dark-lite dark:to-dark-light dark:text-white-deep">
      <div className="w-11/12 flex-col lg:flex-row flex items-center justify-between mx-auto space-y-4">
        ...
        <div className="flex max-sm:flex-col justify-center items-center space-x-5 max-sm:space-y-5">
          {/* Mobile Email */}
          <a className="lg:hidden" href="mailto:tariqul.developer@gmail.com" target="_blank" rel="noopener noreferrer">
            <p className="font-semibold text-dark-lite dark:text-white-deep hover:text-dark-deep">tariqul.developer@gmail.com</p>
          </a>

          {/* Desktop Email */}
          <a className="hidden lg:block" href="https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&to=tariqul.developer@gmail.com" target="_blank" rel="noopener noreferrer">
            <p className="font-semibold text-dark-lite dark:text-white-deep hover:text-dark-deep">tariqul.developer@gmail.com</p>
          </a>

          {/* Phone */}
          <a href="tel:+8801743892058">
            <p className="font-semibold text-dark-lite dark:text-white-deep hover:text-dark-deep">+8801743892058</p>
          </a>
          ...
          <div className="flex space-x-2 mt-2 social-icon mb-3">
            <ul className="flex gap-3 items-center justify-center lg:justify-start">
              <li>
                <a href="https://www.facebook.com/tariqul.islam.fb" target="_blank" rel="noopener noreferrer">
                  <Facebook size={30} className="hero-icon lang" />
                </a>
              </li>
              <li>
                <a href="https://github.com/tariqul420" target="_blank" rel="noopener noreferrer">
